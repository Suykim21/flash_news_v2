...
def subscribe(request):
    ...
    if sub_results['new'] != None:
      ...
      return JsonResponse(json.dumps({'success': True, 'errors': sub_results['success_list']}), safe=False)
    else:
      # return redirect('home')
      return JsonResponse(json.dumps({'success': False, 'errors': sub_results['error_list']}), safe=False)
